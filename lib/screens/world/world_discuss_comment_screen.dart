...
class WorldDiscussCommentScreen extends StatefulWidget {
  WorldDiscussCommentScreen({Key? key,required this.wid,required this.pageNum}) : super(key: key);
  int wid;
  int pageNum;
  @override
  State<WorldDiscussCommentScreen> createState() => _WorldDiscussCommentScreenState();
}

class _WorldDiscussCommentScreenState extends State<WorldDiscussCommentScreen> {
  ...
  @override
  void didUpdateWidget(covariant WorldDiscussCommentScreen oldWidget) {
